...
export interface DataStore extends KeyValueStore<Key, Value, Entry>, StoreSelector<Entry>, StoreBatch<Key, Value>, Resource {
}
...
export declare type Value = Uint8Array;
