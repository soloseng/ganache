declare function _exports(context: any): (path: string, options?: (TouchOptions & import("../../utils").AbortOptions) | undefined) => Promise<void>;
export = _exports;
...
export type UnixTime = Date | [number, number] | import("ipfs-core-utils/src/files/format-mtime").MTime;
