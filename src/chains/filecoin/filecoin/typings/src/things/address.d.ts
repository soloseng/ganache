...
declare class Address extends SerializableLiteral<AddressConfig> {
    ...
    static fromPrivateKey(privateKey: string, protocol?: AddressProtocol, network?: AddressNetwork): Address;
    static random(rng?: RandomNumberGenerator, protocol?: AddressProtocol, network?: AddressNetwork): Address;
     ...
     */
    static fromId(id: number, isSingletonSystemActor?: boolean, isMiner?: boolean, network?: AddressNetwork): Address;
