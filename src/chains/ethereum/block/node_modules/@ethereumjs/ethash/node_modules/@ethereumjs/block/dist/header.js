...
class BlockHeader {
    ...
    constructor(headerData, options = {}) {
        ...
        const withdrawalsRoot = (0, util_1.toType)(headerData.withdrawalsRoot, util_1.TypeOutput.Buffer) ?? defaults.withdrawalsRoot;
        ...
        if (this._common.isActivatedEIP(1559) === true) {
            if (baseFeePerGas === undefined) {
                if (number === this._common.hardforkBlock(common_1.Hardfork.London)) {
        ...
        if (this._common.isActivatedEIP(4895)) {
            ...
            if (withdrawalsRoot !== undefined) {
                throw new Error('A withdrawalsRoot for a header can only be provied with EIP4895 being activated');
            }
        }
