...
export declare function sendFragmented(ws: WebSocket, data: Generator<Buffer, void, void>, useBinary: boolean, chunkSize: number): void;
...
export declare type WebsocketServerOptions = Pick<InternalOptions["server"], "wsBinary" | "rpcEndpoint" | "chunkSize">;
