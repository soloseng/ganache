...
export interface Bitswap extends StoreReader<CID, Block>, StoreExporter<CID, Block>, StoreImporter<Block> {
...
export declare type BlockPresence = {
    cid: Uint8Array;
    type: BlockPresenceType;
};
export declare type Have = 0;
export declare type DontHave = 1;
export declare type BlockPresenceType = Have | DontHave;
export declare type WantBlock = 0;
export declare type HaveBlock = 1;
export declare type WantType = WantBlock | HaveBlock;
