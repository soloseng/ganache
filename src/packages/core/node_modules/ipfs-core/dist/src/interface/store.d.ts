...
export interface KeyValueStore<Key, Value, Entry> extends StoreReader<Key, Value>, StoreExporter<Key, Value>, StoreSelector<Entry>, StoreLookup<Key>, StoreWriter<Key, Value>, StoreImporter<Entry>, StoreEraser<Key> {
}
