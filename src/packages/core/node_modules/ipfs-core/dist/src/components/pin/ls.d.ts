...
}): (options?: (LsSettings & import("../../utils").AbortOptions) | undefined) => AsyncIterable<LsEntry>;
export = _exports;
export type LsOptions = LsSettings & import("../../utils").AbortOptions;
export type LsSettings = {
    /**
     * - CIDs or IPFS paths to search for in the pinset.
     */
    paths?: string[] | import("cids/src/")[] | undefined;
    /**
