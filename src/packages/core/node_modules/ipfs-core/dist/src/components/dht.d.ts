declare function _exports({ network, repo }: {
    ...
    findProvs: (cid: import("cids/src/"), options?: (FindProvsOptions & import("../utils").AbortOptions) | undefined) => AsyncIterable<PeerInfo>;
    findPeer: (peerId: import("cids/src/") | import("peer-id"), options?: import("../utils").AbortOptions | undefined) => Promise<{
        id: string;
        addrs: Multiaddr[];
    }>;
    provide: (cids: import("cids/src/") | import("cids/src/")[], options?: (ProvideOptions & import("../utils").AbortOptions) | undefined) => AsyncIterable<QueryEvent>;
