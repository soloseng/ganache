...
import { GanacheRawBlockTransactionMetaData, TypedDatabaseTransaction, TypedTransaction, TypedTransactionJSON } from "@ganache/ethereum-transaction";
...
export declare class Block {
    ...
    private _hash;
    hash(): Data;
    getTransactions(): (import("@ganache/ethereum-transaction").LegacyTransaction | import("@ganache/ethereum-transaction").EIP2930AccessListTransaction | import("@ganache/ethereum-transaction").EIP1559FeeMarketTransaction)[];
