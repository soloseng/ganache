declare function _exports(context: any): (path: string, options?: (MkdirOptions & import("../../utils").AbortOptions) | undefined) => Promise<void>;
export = _exports;
export type MkdirOptions = {
     ...
     */
    mtime?: Date | import("../../utils").Mtime | [number, number] | undefined;
    /**
