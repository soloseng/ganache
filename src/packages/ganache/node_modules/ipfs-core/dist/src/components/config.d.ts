declare function _exports({ repo }: {
    ...
    getAll: (options?: import("../utils.js").AbortOptions | undefined) => Promise<IPFSConfig>;
    get: (key: string, options?: import("../utils.js").AbortOptions | undefined) => Promise<import("../interface/basic.js").ToJSON>;
    set: (key: string, value: import("../interface/basic.js").ToJSON, options?: import("../utils.js").AbortOptions | undefined) => Promise<void>;
    replace: (value: IPFSConfig, options?: import("../utils.js").AbortOptions | undefined) => Promise<void>;
    profiles: {
...
declare namespace _exports {
    export { profiles };
    export { Config, Get, GetAll, Set, Replace, Profiles, ListProfiles, Profile, ApplyProfile, ApplyOptions, IPFSConfig, AddressConfig, Multiaddr, APIAddress, DelegateAddress, GatewayAddress, SwarmAddress, BootstrapConfig, DatastoreConfig, DatastoreSpec, DiscoveryConfig, MDNSDiscovery, WebRTCStarDiscovery, IdentityConfig, PeerID, PrivateKey, KeychainConfig, DEK, PubsubConfig, PubSubRouter, SwarmConfig, ConnMgrConfig, RoutingConfig, ToJSON, AbortOptions };
}
export = _exports;
export type Config = {
    get: Get;
 ...
 * the stored config.
 */
export type Get = (key: string, options?: import("../utils.js").AbortOptions | undefined) => Promise<ToJSON>;
/**
 ...
 * an effect.
 */
export type Set = (key: string, value: ToJSON, options?: import("../utils.js").AbortOptions | undefined) => Promise<void>;
/**
 ...
 */
export type Replace = (value: IPFSConfig, options?: import("../utils.js").AbortOptions | undefined) => Promise<void>;
 ...
 * List available config profiles
 */
export type ApplyProfile = (name: string, options?: (ApplyOptions & import("../utils.js").AbortOptions) | undefined) => Promise<{
    original: IPFSConfig;
    updated: IPFSConfig;
}>;
...
export type ToJSON = string | number | boolean | import("../interface/basic.js").ToJSON[] | ({
    toJSON?: (() => import("../interface/basic.js").ToJSON) | undefined;
} & {
    [key: string]: import("../interface/basic.js").ToJSON;
}) | null;
