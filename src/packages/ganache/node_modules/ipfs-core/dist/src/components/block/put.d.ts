...
}): (block: Uint8Array | import("../../interface/basic").Block, options?: (PutOptions & import("../../utils").AbortOptions) | undefined) => Promise<import("../../interface/basic").Block>;
export = _exports;
export type PutOptions = {
    /**
     * - A CID to store the block under (default: `undefined`)
     */
    cid?: import("cids/src/") | undefined;
    /**
...
export type IPLDBlock = import("../../interface/basic").Block;
