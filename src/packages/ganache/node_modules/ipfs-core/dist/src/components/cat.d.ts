...
}): (ipfsPath: string | import("cids/src/"), options?: (CatOptions & import("../utils").AbortOptions) | undefined) => AsyncIterable<Uint8Array>;
export = _exports;
export type Options = CatOptions & import("../utils").AbortOptions;
