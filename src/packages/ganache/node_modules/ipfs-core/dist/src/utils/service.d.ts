 ...
 *
 */
declare class Service<Options_1, T> {
    /**
    ...
    static create<T_1 extends (options: any) => Await<any>>({ start, stop }: {
        start: T_1;
        stop?: ((state: ReturnType<T_1> extends Promise<infer U> | null ? U : ReturnType<T_1>) => Await<void>) | undefined;
    }): import("./service")<Parameters<T_1>[0], ReturnType<T_1> extends Promise<infer U> | null ? U : ReturnType<T_1>>;
    /**
     ...
     * @returns {Promise<T>}
     */
    static start<Options_2, T_2>(service: import("./service")<Options_2, T_2>, options: Options_2): Promise<T_2>;
    /**
     ...
     * @returns {Promise<T>}
     */
    static use<T_5>({ state }: import("./service")<any, T_5>, options?: import("../utils").AbortOptions | undefined): Promise<T_5>;
    /**
     * @private
     ...
     */
    private constructor();
    activate: (options: Options_1) => import("../interface/basic").Await<T>;
     ...
     * @returns {Promise<T>}
     */
    use(options?: import("../utils").AbortOptions | undefined): Promise<T>;
    /**
     * @returns {T|null}
     */
    try(): T | null;
...
type ServiceState<T> = {
    ...
    status: 'starting';
    ready: import("../interface/basic").Await<T>;
} | {
    status: 'started';
    value: T;
} | {
