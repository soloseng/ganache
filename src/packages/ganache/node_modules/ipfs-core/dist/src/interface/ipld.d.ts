...
export interface IPLD<T = any> extends StoreReader<CID, T>, StoreExporter<CID, T>, StoreEraser<CID> {
...
export declare type FormatCode = number;
export declare type HashAlg = number;
