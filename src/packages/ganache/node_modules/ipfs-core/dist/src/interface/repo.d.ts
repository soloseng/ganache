...
import { ValueStore, StoreReader, Resource, StoreLookup, StoreImporter, StoreExporter, StoreEraser, StoreSelector, KeyValueStore } from './store';
export interface Repo<Config extends ToJSON = any> extends Resource {
    ...
    root: KeyValueStore<Key | string | Uint8Array, Uint8Array, {
        key: Key;
        value: Uint8Array;
    }>;
    blocks: BlockStore;
...
interface BlockStore extends StoreImporter<Block>, StoreReader<CID, Block>, StoreLookup<CID>, StoreExporter<CID, Block>, StoreEraser<CID>, StoreSelector<Block> {
    put(block: Block): Await<Block>;
}
export interface ConfigStore<Config extends ToJSON = any> extends StoreReader<string, ToJSON> {
    /**
...
export interface PinStore extends KeyValueStore<string, Uint8Array, {
    key: string;
    value: Uint8Array;
}>, Object {
}
export interface KeyStore extends KeyValueStore<Key, Uint8Array, {
    key: Key;
    value: Uint8Array;
}>, Object {
}
