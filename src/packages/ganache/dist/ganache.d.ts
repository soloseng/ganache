...
declare type AccessListItem = {
    address: PrefixedHexString_2;
    storageKeys: PrefixedHexString_2[];
};
...
balance: PrefixedHexString_2,
code: PrefixedHexString_2,
 ...
 */
declare type AddressLike = Address_2 | Buffer | PrefixedHexString_2;
...
declare abstract class BaseTransaction_2<TransactionObject> {
     ...
     */
    protected _getCommon(common?: Common, chainId?: BigIntLike_2): Common;
    /**
...
declare type BigIntLike_2 = bigint | PrefixedHexString_2 | number | Buffer;
...
declare class Blockchain_2 implements BlockchainInterface {
     ...
     */
    private _getHeader;
    protected checkAndTransitionHardForkByNumber(number: bigint, td?: BigIntLike_2): void;
    /**
...
declare type BufferLike = Buffer | Uint8Array | number[] | number | bigint | TransformableToBuffer | PrefixedHexString_2;
...
declare class Common extends EventEmitter {
    ...
    declare interface FeeMarketEIP1559TxData extends AccessListEIP2930TxData {
         ...
         */
        maxPriorityFeePerGas?: BigIntLike_2;
        /**
         * The maximum total fee
         */
        maxFeePerGas?: BigIntLike_2;
    }
    ...
    declare interface GenesisState {
        [key: PrefixedHexString_2]: PrefixedHexString_2 | AccountState;
    }
    ...
    declare interface HeaderData {
        ...
        difficulty?: BigIntLike_2;
        number?: BigIntLike_2;
        gasLimit?: BigIntLike_2;
        gasUsed?: BigIntLike_2;
        timestamp?: BigIntLike_2;
        extraData?: BufferLike;
        mixHash?: BufferLike;
        nonce?: BufferLike;
        baseFeePerGas?: BigIntLike_2;
    }
    ...
    declare type PrefixedHexString_2 = string;
    ...
    declare type Proof = {
        address: PrefixedHexString_2;
        balance: PrefixedHexString_2;
        codeHash: PrefixedHexString_2;
        nonce: PrefixedHexString_2;
        storageHash: PrefixedHexString_2;
        accountProof: PrefixedHexString_2[];
    ...
    declare type StoragePair = [key: PrefixedHexString_2, value: PrefixedHexString_2];

    declare type StorageProof = {
        key: PrefixedHexString_2;
        proof: PrefixedHexString_2[];
        value: PrefixedHexString_2;
    };
